...
var peso = parseInt(prompt("Cuál es tu peso?")); /*parseInt tambien me sirve para convertir el texto plano en texto no plano xd*/
var planeta = parseInt(prompt("En que planeta quieres saber tu peso.\nEscoge 1 para Marte y 2 para Jupiter"));
var g_t = 9.8;
var g_m = 3.7;
var g_j = 24.8;
